...
public class EstudianteDTO {
	...
	public EstudianteDTO(String nombreEstudiante, String colegio, String homologado, String carreraCosto, int estrato,
			String edad) {
	...
	public String toString() {
		return "Estudiante [nombreEstudiante=" + nombreEstudiante + ", colegio=" + colegio + ", homologado="
				+ homologado + ", carreraCosto=" + carreraCosto + ", estrato=" + estrato + ", edad="
				+ edad + "]";
	}
